...
class Device:
    ...
    def __init__(self, config, device_config):
        ...
        self.__notification_queue_in = Queue(2)
        self.__notification_queue_in_lock = Lock()

        self.__notification_queue_out = Queue(2)
        self.__notification_queue_out_lock = Lock()
        ...
        self.__output_service = EffectService()
    ...
    def get_notification_queue_in(self):
        return self.__notification_queue_in

    def get_notification_queue_in_lock(self):
        return self.__notification_queue_in_lock
    ...
    notification_queue = property(get_notification_queue_in)
    notification_queue = property(get_notification_queue_in_lock)
